...
class LinkedList {
  ...
  // Time Complexity: O(N) except for insertions at the starting index and ending index
  // Auxiliary Space Complexity: O(1)
  insert(value, index) {
    ...
    if (this.length === 0){
      ...
      for (let x = 0; x < index - 1; x++){
        // roll the reference continuously until reaching the position before insertion index
        prev = prev.next;
      }
