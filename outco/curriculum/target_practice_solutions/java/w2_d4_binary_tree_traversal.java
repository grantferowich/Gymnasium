...
class BTProblems {
  ...
  private static void dfsPreTraverse(TreeNode current, List<Integer> result) {
  ...
  private static void dfsInTraverse(TreeNode current, List<Integer> result) {
    if (current == null) {
      return;
    }
  ...
  private static void dfsPostTraverse(TreeNode current, List<Integer> result) {
    if (current == null) {
      return;
    }
