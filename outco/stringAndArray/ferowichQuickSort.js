 ...
 * Ferowich Quick Sort
 * 
 * The interesting quick sort values are v between the 25th and 75th percentiles.
 ...
 * 
 * Only use v values in quick sort which are within some range of useful values.
 * The result is that quick sort never runs with the worst case run time (O(N^2))
 * The result is that quick sort is gauranteed to run with the best case runtime (NlogN).
